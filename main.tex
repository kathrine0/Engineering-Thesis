...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
	...
	\label{id:cha:specyfikacja_wewnetrzna}
		...
		\label{id:sec:algorytmy}
			...
			Oczywiście trzeba pamiętać, że rachunki powyższe nie uwzględniają tego, że Ziemia nie jest kulą, dlatego są obarczone pewnym błędem. Jednakże taki błąd jest dopuszczalny w przypadku aplikacji \appName. \ksremark{bez spacji przed kropką}
