...
\mainmatter % powoduje, ze wlasciwa czesc pracy ma strony numerowe od 1 cyframi arabskimi
	...
	\label{id:cha:wstep}
			...
			Branżą, która rozwija się jeszcze szybciej niż turystyka, jest branża IT. Jeszcze 10 lat temu nikomu nie śniło się, że dziś prawie każdy posiadać będzie telefon typu smartfon\footnote{ang. \emph{smartphone} -- dosłownie ,,mądry telefon''}\ksremark{Nie jestem przekonany, czy jest konieczne tłumaczenie <<smartfon>>.}. Turystyka nie nadąża za rozwojem IT, więc w chwili obecnej na rynku istnieje nisza, jeśli chodzi o przewodniki elektroniczne.
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
	...
	\label{id:cha:specyfikacja_wewnetrzna}
		...
		\ksremark{Tytuł jest w liczbie mnogiej, poczym jest opisany tylko jeden algorytm.}
