...
\mainmatter % powoduje, ze wlasciwa czesc pracy ma strony numerowe od 1 cyframi arabskimi
	...
	\ksremark{Rozdział opisuje technologie i narzędzia użyte do stworzenia części webowej, serwerowej i mobilnej aplikacji.}
...
%		\section{Technologia wykorzystana w części serwerowej}
		...
		\ksremark{Skróciłem tytuł podrozdziału.}
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
	...
	\chapter{Specyfikacja wewnętrzna}
		...
		Na cały system składają się trzy aplikacje: aplikacja mobilna (\emph{Mobile app}), aplikacja internetowa (\emph{Website}) oraz aplikacja serwerowa (\emph{WebService}). Związek pomiędzy tymi aplikacjami przedstawiony jest na rysunku \ref{fig:architektura}. 
			...
			Schemat architektury aplikacji mobilnej \ksremark{na pewno mobilnej?} przedstawiony jest na rysunku \ref{fig:architektura_server}. 			
			...
			Schemat architektury aplikacji mobilnej \ksremark{na pewno mobilnej?} przedstawiony jest na rysunku \ref{fig:architektura_webapp}.	
