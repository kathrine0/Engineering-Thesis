...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
	...
	\label{id:cha:zakonczenie}
		...
		W wyniku przeprowadzonego projektu powstała w pełni użyteczna platforma \appName\ gotowa do wdrożenia do użytku przez użytkowników końcowych. Program ułatwia podróżnikom zwiedzanie nowych miejsc i może zastąpić tradycyjne przewodniki. Dodatkową przewagą nad książkowymi przewodnikami jest wykorzystanie danych geolokalizacyjnych pobranych z urządzenia GPS wbudowanego smartfon oraz możliwość stałego aktualizowania treści. Na całość składa się aplikacja mobilna na platformę Windows Phone 8.1 oraz aplikacja działająca w przeglądarce internetowej. 
